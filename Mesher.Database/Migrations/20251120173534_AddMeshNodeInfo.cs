...
{
    /// <inheritdoc />
    public partial class AddMeshNodeInfo : Migration
    {
        /// <inheritdoc />
...
SELECT DISTINCT ON (""From"", ""CreatedAt"") ('0x' || replace(""RawMessage"" -> 'payload' ->> 'id', '!', ''))::bigint AS ""Id"",
...
ORDER BY ""CreatedAt"" DESC;");
        ...
        {
            migrationBuilder.Sql(@"DROP VIEW IF EXISTS ""MeshNodeInfo"";");
        }
    }
}
